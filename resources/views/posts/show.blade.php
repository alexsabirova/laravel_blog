            ...
            <section class="post-content">
                ...
                <div class="row mb-5">
                    <div class="col-md-4 mb-3" data-aos="fade-right">
                        <img src="{{ asset('storage/' . $post->thumbnail) }}" alt="blog post" class="img-fluid">
                    </div>
            ...
            <div class="row">
                <div class="col-lg-9 mx-auto">
                        ...
                        <div class="row">
                            @foreach($relatedPosts as $relatedPost)
                                <div class="col-md-4" data-aos="fade-right" data-aos-delay="100">
                                    <img src="{{ asset('storage/' . $relatedPost->thumbnail) }}" alt="related post"
                    ...
                    <section class="comment-list mb-5">
                        <h2 class="section-title mb-3" data-aos="fade-up">Комментарии({{ $post->comments->count() }}
                            )</h2>
                        @foreach($post->comments as $comment)
                            <div class="comment-text mb-3">
                            <span class="username">
                                <div class="text-">{{ $comment->user->name}}</div>
